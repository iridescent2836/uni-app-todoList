...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__89C1799",
    appName: "uni-app-todolist-demo",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"uni-app-todolist-demo","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************************!*\
  !*** D:/codeProject/uni-app-todolist-demo/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
var store = new _vuex.default.Store({
  state: {
    test: 'Hello vuex',
    isAllChecked: false,
    // whether all the items are checked
    hideChecked: false,
    // when true, only show the unchecked items, otherwise show all items
    todoList: [
  ...
  mutations: {
    ...
    removeTodo: function removeTodo(state, id) {
      var index = state.todoList.findIndex(function (item) {
        return item.id === id;
      });
      state.todoList.splice(index, 1);
    },
    checkTodo: function checkTodo(state, id) {
      var index = state.todoList.findIndex(function (item) {
        return item.id === id;
      });
      state.todoList[index].isCheck = !state.todoList[index].isCheck;
      state.isAllChecked = state.todoList.every(function (item) {
        return item.isCheck;
      });
    },
    ...
    hideChecked: function hideChecked(state) {
      state.hideChecked = !state.hideChecked;
    }
  },
  getters: {
    toJson: function toJson(state) {
      return JSON.stringify(state.todoList);
    },
    allTodoList: function allTodoList(state) {
      return state.todoList;
    },
    uncheckedTodoList: function uncheckedTodoList(state) {
